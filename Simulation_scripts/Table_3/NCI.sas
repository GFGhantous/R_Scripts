...
libname mylib  "C:\Users\Giovana\Desktop\Dados consumo\cenario12";
...
data EQM;
set append;
E5=((tpercentile5-442.08)/442.08)**2;
E10=((tpercentile10-526.85)/710.79)**2;
E25=((tpercentile25-710.79)/710.79)**2;
E50=((tpercentile50-986.74)/986.74)**2;
E75=((tpercentile75-1361.78)/1361.78)**2;
E90=((tpercentile90-1814.55)/1814.55)**2;
E95=((tpercentile95-2147.29)/2147.29)**2;
run;
