...
vita=((x*0.0371)+1)^(1/0.0371)

dados1=data.frame(ind,rec,vita)

m1<-gamlss(vita~1,tau.start=4,tau.fix=TRUE,data=dados1,family=BCT(mu.link=log))
...
verdadeiroperc<-c(304.41,364.97,496.26,694.40,967.44,1298.55,1543.38)
