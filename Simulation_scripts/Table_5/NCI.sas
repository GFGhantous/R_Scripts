   ...
   do nid=1 to 500;
    ...
    sb2 = sqrt(varsb2)*z2;
        do day=1 to 3;
		 e2=exp(1+sb2)/2;
		 e3=exp(4+sb2)/2;
		call rangam(seed3,e2,x2);
        call rangam(seed3,e3,x3);
       y2=2*x2;
	   y3=2*x3;
	   id=id+1;
...
if id=2 then y2=y3;   if id=3 then y2=y3;   if id=12 then y2=y3;  if id=18 then y2=y3;   if id=25 then y2=y3; if id=28 then y2=y3;
if id=37 then y2=y3;  if id=39 then y2=y3;  if id=40 then y2=y3;  if id=45 then y2=y3;   if id=52 then y2=y3;  if id=61 then y2=y3;
if id=79 then y2=y3;  if id=85 then y2=y3; if id=94 then y2=y3; if id=103 then y2=y3;  if id=113 then y2=y3; if id=129 then y2=y3;
if id=137 then y2=y3; if id=143 then y2=y3; if id=150 then y2=y3; if id=167 then y2=y3;  if id=176 then y2=y3; if id=181 then y2=y3;
if id=199 then y2=y3; if id=209 then y2=y3; if id=210 then y2=y3; if id=230 then y2=y3;  if id=249 then y2=y3; if id=330 then y2=y3;
if id=389 then y2=y3;if id=405 then y2=y3;if id=454 then y2=y3;if id=596 then y2=y3;  if id=580 then y2=y3; if id=628 then y2=y3;
if id=627 then y2=y3;if id=714 then y2=y3;if id=790 then y2=y3;if id=803 then y2=y3; if id=902 then y2=y3;if id=994 then y2=y3;
if id=1009 then y2=y3;if id=1180 then y2=y3;if id=1291 then y2=y3;if id=1381 then y2=y3; if id=1301 then y2=y3;if id=1486 then y2=y3;
if id=1500 then y2=y3;if id=1459 then y2=y3;if id=896 then y2=y3; if id=701 then y2=y3;    if id=955 then y2=y3; if id=501 then y2=y3;
...
if id=73 then y2=y3;  if id=220 then y2=y3; if id=967 then y2=y3; if id=43 then y2=y3;   if id=288 then y2=y3;  if id=893 then y2=y3;
...
if id=34 then y2=y3;  if id=511 then y2=y3;  if id=1359 then y2=y3;
        output;
        end;
  end;
keep y2 nid day id y3;
run;
%end;
%mend;
%gammas; 

libname mylib  "C:\Users\Giovana\Desktop\Dados consumo\cenario102";
...
data EQM;
set append;
E5=((tpercentile5-2.266634)/2.266634)**2;
E10=((tpercentile10-2.729924)/2.729924)**2;
E25=((tpercentile25-3.735130)/3.735130)**2;
E50=((tpercentile50-5.288115)/5.288115)**2;
E75=((tpercentile75-7.471036)/7.471036)**2;
E90=((tpercentile90-10.173281)/10.173281)**2;
E95=((tpercentile95-12.261041)/12.261041)**2;
run;
