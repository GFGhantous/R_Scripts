...
y=rBCT(1500,mu=mu,sigma=0.5,nu=0.5,tau=4)

dados1=data.frame(ind,rec,y)


m1<-gamlss(y~1,data=dados1,family=BCT(mu.link=log))
...
ll[i]<-gauss.hermite(modelo,n.pontos=pontos,X=X,Z=Z,Y=dados.id[[i]]$dados1.y,
...
verdadeiroperc<-c(46.58,60.30,92.79,149.32,240.65,370.94,480.62)
...
verdadeiroparametro<- c(5,0.5,0.5,4,sqrt(0.5))
viesrparametros<-c(((-verdadeiroparametro[1]+estimativasfinais[1])/verdadeiroparametro[1])*100,
((-verdadeiroparametro[2]+estimativasfinais[2])/verdadeiroparametro[2])*100,
((-verdadeiroparametro[3]+estimativasfinais[3])/verdadeiroparametro[3])*100,
((-verdadeiroparametro[4]+estimativasfinais[4])/verdadeiroparametro[4])*100,
((-verdadeiroparametro[5]+estimativasfinais[5])/verdadeiroparametro[5])*100)
viesrparametros

EQMrparametros<-c(sqrt(sum(((A1[,8]-verdadeiroparametro[1])/verdadeiroparametro[1])^2)/l),
sqrt((sum(((A1[,9]-verdadeiroparametro[2])/verdadeiroparametro[2])^2))/l),
sqrt((sum(((A1[,10]-verdadeiroparametro[3])/verdadeiroparametro[3])^2))/l),
sqrt((sum(((A1[,11]-verdadeiroparametro[4])/verdadeiroparametro[4])^2))/l),
sqrt((sum(((A1[,12]-verdadeiroparametro[5])/verdadeiroparametro[5])^2))/l))
EQMrparametros
