...
%do c=1 %to 500;
data sim&c;
seed1=895&c.;seed2=478&c.;seed3=65&c.;id=0;
   do nid=1 to 500;
   varsb2=0.3897;
    vars2 = 1.2186;
    ...
    sb2 = sqrt(varsb2)*z2;
        do day=1 to 3;
		 call rannor(seed3,e2);
		  x1 = 7.4056 + sb2 + sqrt(vars2)*e2; 
		  x2 = 9 + sb2 + sqrt(vars2)*e2; 
                                   lb = 0.0371;
           y2=(x1*lb + 1)**(1/lb);
		   y3=(x2*lb + 1)**(1/lb);
		    id=id+1;
                                   if y2<=0 then y2=0.001;
								   if y3<=0 then y3=0.001;
if id=2 then y2=y3;   if id=3 then y2=y3;   if id=90 then y2=y3;  if id=89 then y2=y3;   if id=102 then y2=y3; if id=54 then y2=y3;
if id=17 then y2=y3;  if id=46 then y2=y3;  if id=58 then y2=y3;  if id=65 then y2=y3;   if id=82 then y2=y3;  if id=71 then y2=y3;
if id=99 then y2=y3;  if id=105 then y2=y3; if id=134 then y2=y3; if id=163 then y2=y3;  if id=183 then y2=y3; if id=69 then y2=y3;
if id=555 then y2=y3; if id=423 then y2=y3; if id=370 then y2=y3; if id=347 then y2=y3;  if id=206 then y2=y3; if id=51 then y2=y3;
if id=678 then y2=y3; if id=749 then y2=y3; if id=890 then y2=y3; if id=901 then y2=y3;  if id=999 then y2=y3; if id=33 then y2=y3;
if id=1389 then y2=y3;if id=1255 then y2=y3;if id=1254 then y2=y3;if id=396 then y2=y3;  if id=980 then y2=y3; if id=28 then y2=y3;
if id=1427 then y2=y3;if id=1114 then y2=y3;if id=1190 then y2=y3;if id=1103 then y2=y3; if id=1402 then y2=y3;if id=1194 then y2=y3;
if id=1499 then y2=y3;if id=1320 then y2=y3;if id=1091 then y2=y3;if id=1081 then y2=y3; if id=1301 then y2=y3;if id=486 then y2=y3;
if id=1500 then y2=y3;if id=1459 then y2=y3;if id=234 then y2=y3; if id=7 then y2=y3;    if id=232 then y2=y3; if id=501 then y2=y3;
if id=1276 then y2=y3;if id=1361 then y2=y3;if id=901 then y2=y3; if id=16 then y2=y3;   if id=27 then y2=y3;  if id=729 then y2=y3;
if id=73 then y2=y3;  if id=220 then y2=y3; if id=902 then y2=y3; if id=43 then y2=y3;   if id=28 then y2=y3;  if id=893 then y2=y3;
if id=48 then y2=y3;  if id=999 then y2=y3; if id=879 then y2=y3; if id=643 then y2=y3;  if id=29 then y2=y3;  if id=1111 then y2=y3;
if id=34 then y2=y3;  if id=25 then y2=y3;  if id=1359 then y2=y3;
        output;
        end;
  end;
keep y2 y3 id nid day;
run;
%end;
%mend;
%normais; 

libname mylib  "C:\Users\Giovana\Desktop\Dados consumo\cenario30";
...
data EQM;
set append;
E5=((tpercentile5-493.43)/493.43)**2;
E10=((tpercentile10-590.02)/590.02)**2;
E25=((tpercentile25-794.73)/794.73)**2;
E50=((tpercentile50-1099.84)/1099.84)**2;
E75=((tpercentile75-1513.69)/1513.69)**2;
E90=((tpercentile90-2012.91)/2012.91)**2;
E95=((tpercentile95-2386.86)/2386.86)**2;
run;
